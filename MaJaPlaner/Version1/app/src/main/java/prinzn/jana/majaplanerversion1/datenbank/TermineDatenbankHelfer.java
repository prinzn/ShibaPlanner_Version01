...
public class TermineDatenbankHelfer extends SQLiteOpenHelper {
    ...
    public static final String SPALTE_NOTIZEN = "notizen";    //Speicherort für Notizen

    public static final String SPALTE_ERSTELLUNG = "erstellung";    //Speicherort für Erstellungsdatum
