...
public class Termin_Bearbeitung_GUI extends AppCompatActivity implements View.OnClickListener,
    ...
    private TextView startDatum, startZeit, endDatum, endZeit, txtEnde, txtStart, txtGanztaegig, txtFreunde;
    ...
    private void initialisieren() {
        ...
        txtFreunde = findViewById(R.id.txt_Terminbearbeitung_Freunde);
    ...
    private void setztenDerOnClickListener() {
        ...
        txtFreunde.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                strg.freundeGeklickt();
            }
        });
    }
