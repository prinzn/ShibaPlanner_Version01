...
public class Kalender_Adapter extends ArrayAdapter<Calendar> {
    ...
    private void termineAnzeigen(View pView, int pFarbe) {
        ...
        if (terminAnzeige1.getVisibility() != View.VISIBLE) {
            ...
            terminAnzeige1.setBackgroundColor(pFarbe); //bei einem Termin soll es eingefärbt werden
            ...
            terminAnzeige2.setBackgroundColor(pFarbe); //bei einem Termin soll es eingefärbt werden
            ...
            terminAnzeige3.setBackgroundColor(pFarbe); //bei einem Termin soll es eingefärbt werden
            ...
            terminAnzeige4.setBackgroundColor(pFarbe); //bei einem Termin soll es eingefärbt werden
        }
    }
